...
class RestaurantsAdapter(var context : Context, var restaurantsList : ArrayList<Pair<com.gmail_bssushant2003.journeycraft.Models.LatLng, Restaurant>>) : RecyclerView.Adapter<RestaurantsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.binding.restName.text = restaurantsList[position].second.name
        holder.binding.restMobileNumber.text = restaurantsList[position].second.phoneNo
...
//            holder.itemView.context.startActivity(intent)
            ...
            val locationUrl = restaurantsList[position].second.locationLink
